...
public class StoryFragment extends Fragment {
    private ImageButton buttonseemore2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonseemore2 = view.findViewById(R.id.buttonseemore2);

        buttonseemore2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.riotgames.com/en/who-we-are"));
